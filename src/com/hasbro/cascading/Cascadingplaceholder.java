...
public class Cascadingplaceholder extends TestsuiteBase{
	...
	public static By Class = By.xpath("//td[contains(text(),'Class (PLC)')]//following::select[1]");
   ...
   //for search placeholder
	public static By Searchplaceholder = By.id("searchDropDownSelect");
	public static By Placeholder = By.id("searchField");
	public static By actplc = By.xpath("//div[@id='contentDiv']/table/tbody/tr[1]//select[contains(@onchange,'evalList(this)')]");
	public static By optionUpdate = By.xpath("//select[contains(@onchange,'evalList(this)')]/option[contains(text(),'Update')]");
	
	public static By actionPH = By.xpath("//select[contains(@onchange,'evalList(this)')]/option[contains(text(),'Update')]");
	...
	public void tcProduct(String[] productData) throws Exception{
		try{
			...
			log.debug("Inside testcase for Placeholder Cascading");
			...
			if(productData[3].equalsIgnoreCase("Update"))
			{ SearchPlaceholder(productData); }
			//SetState
	...
	public static boolean SearchPlaceholder(String[] productData) throws Exception{
		try{
		 //	driver.navigate().refresh();
			if(nevflag){
				//select placeholder from header search and search it
				CommonProjectFunctions.searchAttributeType(productData[14], productData[15]);
				driver.switchTo().defaultContent();
				driver.switchTo().frame("contentframe");
				CommonFunctions.clickButtonOrLink(actplc, "btn", "Action dropdown");
				CommonFunctions.clickButtonOrLink(optionUpdate, "option", "Update");
