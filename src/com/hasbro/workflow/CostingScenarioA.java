...
public class CostingScenarioA extends TestsuiteBase{
	private static final String vuser1 = null;
	private static final String plm = null;
	public static By totalRetailItemCount = By.id("r6_hbTotalRetailItemCount");
	...
	static String prodNumRetail1,prodNumRetail2,prodNumRetail3;
	...
	public void tcSCFunctional(String[] data) throws Exception{
		try{
			...
			log.debug("Inside testcase for Security Sourcing Configuration");
	...
	public static String createDevelopmentPlan(String[] data) throws Exception{
		try{
			...
			Assert.assertEquals(strBrand.trim(), data[9]);
	...
	public static String updateForecastAndAttributesAgainstPlaceholders(String[] data) throws Exception{
		try{
			...
			//			//Click on filter button
			//			CommonFunctions.clickButtonOrLink(filterButton, "btn", "Filter Button");
			//			//Select created placeholder
			//			CommonFunctions.selectFromDropDownByVisibleText(filterDDonLS, phName); //phname is coming from step 2,uncomment later
			//			//Click on Options button
			//			CommonFunctions.clickButtonOrLink(optionBtn, "btn", "Option");
			//			//Select from placeholder drop down
			//			CommonFunctions.selectFromDropDownByVisibleText(placeHolderDD, "Placeholders Only");
			...
			CommonFunctions.clickButtonOrLink(filterAction, "btn", "filterAction");
	...
	public static String createProductlinkedtoPlaceholder(String[] data) throws Exception{
		try{
			...
			prodName= CreateProd("Assortment/Solid",data[6], "Development Plan", "Create New: Product", data[7], data[8], data[5], "BOYS", "Assortment", "Not IP Sensitive (Open)", "No", "No", "Mainline", "4", "6", "8", "10");
	...
	public static void fillGlobalLinePlan(String[] data) {
		try{
			...
			//Select Brand
			CommonFunctions.selectFromDropDownByVisibleText(GlobalLinePlan.hbBrand, data[9]);
			//Click on Add
			CommonFunctions.clickButtonOrLink(GlobalLinePlan.lnkAdd, "link", "Add");
			...
			CommonFunctions.enterTextInTextbox(GlobalLinePlan.inPutAssortmentSolidName, data[11]);
	...
	public static String copyLinkProduct(String[] data) {
		try{
			...
			log.info("First retail product:" +prodNum);
		}catch(Exception e){
			fail=true;
			SeleniumDriver.log.error("Exception in createNewPlan()", e);
		}
