...

{
...

    {
        Zip.zipDir(System.getProperty("user.dir")+"\\testng-xslt",System.getProperty("user.dir")+"\\email_xlst_reports.rar" );
                ...
                String[] to={"anjali.p.gupta@accenture.com"};
                ...
                SendMail.sendMail("dilli.r.kumaran.e.l@accenture.com",
                                            "Kohli!23",
                                            "BDC6-LX-723061Y",
                                            "80",
                                            "true",
    ...
    //smtp.mail.accenture.com
       ...
       // props.put("mail.smtps.auth", "true");
...

        {
            ...
            msg.setFrom(new InternetAddress("anjali.p.gupta@accenture.com"));
