...
public class MaterialBOMAnshu extends TestsuiteBase{
	...
	public static By MaterialBOMStatus = By.xpath("//td[contains(text(),'Material BOM Status:')]");
	...
	// public static By headerAttributesBtn = By.xpath("//*[@id='bomEditorSpace']/table/tbody/tr[6]/td/table/tbody/tr/td[2]/a");
	...
	//	public static By headerAttributesPlus= By.id("genDetails_plus']/a[1]/img");
	...
	public static By meterialBOMAction = By.xpath("//a[contains(text(),'Actions:')]");
	//	public static By meterialBOMAction = By.id("materialSupplierActions");

	public static By Deletebutton = By.xpath("//a[contains(text(),'Delete')]");
	...
	public static By updateMBOMStatus = By.xpath("//td[contains(text(),'Material BOM Status')]//following::select[1]");
	...
	public static By USDtoHKD= By.id("hbExchangeRate");
	public static By selectSupplier= By.id("supplierLinkId");
	public static By supplierName= By.xpath("//td[contains(text(),'Name')]//following::input[1]");
	public static By chooseSuppliers = By.name("selectedIds");
	...
	public static By COOField= By.id("r1_hbCountryofOrigin"); 
	public static By field1= By.id("r1_hbBenchmarkCostHKD");
	public static By field2= By.id("r1_hbConstantHKD");
	public static By COO= By.xpath("//a[contains(text(),'Country of Origin:')]");
	public static By benchmarkCostHKD= By.xpath("//td[contains(text(),'*Benchmark Cost (HKD)')]//following::input[2]");
	public static By constantHKD= By.xpath("//td[contains(text(),'*Constant (HKD)')]//following::input[2]");
	public static By save= By.xpath("//a[text()='Save']");
	...
	public static boolean updateFabBOMNames(String[] data) throws Exception
	{
		...
		strInWork="Fabric6NjiB";
		strRejected="Fabric1QOrt";
		strCancelled="FabricLGbkS";
		strReleased="FabricXsBgP"; 
		strUnderReview="FabricGMvGU";
		return true;
	...
	public static boolean verifyBOMStatusReadView(String[] data) throws Exception{
		try{
			...
			if(data[3].contains("BOMStatusRead")&& data[5].equalsIgnoreCase("Yes")){//Read_View
				...
				String BOMStatusInReadView= "Material BOM Status" ;

				String strBOMStatusInReadView = "Material BOM Status" ;
			...
			{
				Assert.assertEquals(driver.findElements(headerAttributesBtn).size(),0);
	...
	{	
		...
		{ 
			...
			isEnabled=  driver.findElement(By.xpath("//td[contains(text(),'Material BOM Status')]//following::select[1]")).isEnabled();
	...
	static String fillMaterailMandatory(String[] data) throws Exception {
		...
		try{
			...
			log.info("crADD is Selected!!!");
			// Send Material Description Details						
			//	CommonFunctions.enterTextInTextboxUpdated(Material.description, data[11],"description");
			// Send Comments for Creating Materials Details
			//	CommonFunctions.enterTextInTextboxUpdated(Material.comments, data[12],"comments");
		}
		catch(Exception e){
			fail=true;
			log.error("Exception in fillMaterailMandatory()", e);
	...
	public static void fillMatFabric(String[] data) throws Exception {
		// TODO Auto-generated method stub
		try{
			//Select Construction Type From drop down
			//	CommonFunctions.selectFromDropDownByVisibleText(Material.construction, data[16]);
			CommonFunctions.selectFromDropDownByVisibleTextUpdated(Material.construction, data[12],"construction");

			//Select Construction Type From drop down
			//	CommonFunctions.selectFromDropDownByVisibleText(Material.constructionType, data[15]);
			...
			//	CommonFunctions.selectFromDropDownByVisibleText(Material.percent, data[14]);
	...
	private static boolean resinmandatoryData(String[] data) throws Exception {
		...
		try{ 
			...
			CommonFunctions.enterTextInTextbox(seasonNumber, data[7]);
	...
	private static boolean labormandatoryData(String[] data) throws Exception {
		...
		try{ 
			...
			CommonFunctions.enterTextInTextbox(Material.labormaterialName, matName);
			CommonFunctions.enterTextInTextbox(Material.txtlaborDescription, "SamplelaborDescription");			
			...
			CommonFunctions.clickButtonOrLink(Material.btnCreateLabor, "btnCreateLabour");
		}
		catch(Exception e){
			fail=true;
	...
	private static boolean trimMandatoryData(String[] data) throws Exception {
		...
		try{ 
			...
			matName = data[4] + date.getTime();
			materialName = data[4] + date.getTime();
			CommonFunctions.enterTextInTextbox(Material.TrimmaterialName, matName);
			...
			CommonFunctions.enterTextInTextbox(Material.txtPercentage, "100");
	...
	private static boolean createResin(String[] data) throws Exception {
		...
		try{ 
			...
			CommonFunctions.selectFromDropDownByVisibleTextUpdated(processingMethod, data[6],"processingMethod");
			...
			CommonFunctions.enterTextInTextbox(density, data[8]);
		}
		catch(Exception e){
			fail=true;
	...
	private static boolean createLabor(String[] data) throws Exception {
		...
		try{ 
			...
			CommonFunctions.selectFromDropDownByVisibleTextUpdated(operationType, data[6],"operationType");
			// Send Labor Description  Details			
			CommonFunctions.enterTextInTextbox(laborDescription, data[7]);
		}
		catch(Exception e){
			fail=true;
	...
	public static Boolean createMeterialBOM(String[] data) throws Exception{
		try{
			...
			CommonFunctions.enterTextInTextbox(inputCompOrLoca,"Mat description");
			//Quanity
		...
		try{
			...
			if(data[5].equalsIgnoreCase("Yes")){//Update
				...
				if(data[0].equalsIgnoreCase("vuser1"))
				{
					String strDescrip = driver.findElement(resultsZero).getText();
					strDescrip=strDescrip.substring(0, 11);
					System.out.println("strDescrip----------"+strDescrip);
					Assert.assertEquals(strDescrip, "Results 0-0");
				}else
				{
	...
	public static boolean delete_MBOM(String[] data) throws Exception{
		try{
			...
			if(data[3].contains("Delete")&& data[5].equalsIgnoreCase("Yes")){
				...
				SeleniumDriver.driver.switchTo().defaultContent();
				SeleniumDriver.driver.switchTo().frame("contentframe");	
				CommonFunctions.clickButtonOrLink(meterialBOMAction, "Delete");
				//			CommonFunctions.clickButtonOrLink(meterialBOMAction, "dropdown", "Material BOM");
				//			CommonFunctions.selectFromDropDownByVisibleTextUpdated(meterialBOMAction, "Delete","meterialBOMAction");
	...
	public static boolean readyForReviewReadView(String[] data) throws Exception{
		try{
			driver.navigate().refresh();
			Thread.sleep(1000);
			CommonProjectFunctions.searchAttributeType("Product", matName);
	...
	public static boolean readyForReviewUpdate(String[] data) throws Exception{
		try{
			...
			if(data[5].equalsIgnoreCase("Yes")){//Update
				...
				Select selectwave= new Select(driver.findElement(currencyvalue));
				String wavename = selectwave.getFirstSelectedOption().getText();

				if (wavename.equals(data[11])){
					CommonFunctions.selectFromDropDownByVisibleText(currencyvalue, data[25]);                          
				}
				else{
					CommonFunctions.selectFromDropDownByVisibleText(currencyvalue, data[26]);                              
				}
				...
				String wavevaluedetailpage= driver.findElement(detailpagecurrencyvalue).getText();
	...
	public static Boolean AddSupplier(String[] data) throws Exception{
		try{			
			...
			//Select check box
			CommonFunctions.selectCheckbox(By.xpath("//a[text()='"+data[23]+"']/preceding::input[1]"));
			//Click on Select
